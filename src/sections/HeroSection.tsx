...
export const HeroSection: React.FC<HeroSectionProps> = ({ onNavigate }) => {
  ...
  return (
    <section
      ref={heroRef}
      id="home"
      className={`relative w-full h-screen min-h-[43.75rem] flex flex-col overflow-hidden select-none transition-colors duration-300 ${
    ...
    >
      ...
      {/* ── NAVBAR SPACER ── */}
      <div className="h-[4.5rem] flex-shrink-0 z-10" />

      {/* ════════ MAIN LAYOUT ════════ */}
      <div className="relative z-10 min-w-0 flex-1 flex flex-col max-w-[87.5rem] 2xl:max-w-[106.25rem] 3xl:max-w-[125rem] mx-auto w-full px-6 md:px-10 lg:px-14">
        ...
        <div className="flex items-start justify-between gap-4 pt-3 flex-1">
          ...
          {/* ── LEFT COPY ── */}
          <div
            className="flex flex-col items-start text-left max-w-[26.875rem] xl:max-w-[29.375rem] will-change-transform"
            style={{
          ...
          >
            ...
            <div style={fadeIn(60)} className="flex items-center gap-2 font-mono-tech text-[0.65625rem] tracking-[0.22em] uppercase font-semibold mt-1">
              ...
              <span className="w-[0.375rem] h-[0.8125rem] bg-[#159FFF] opacity-80" style={{ animation: "blink 1.1s step-end infinite" }} />
            </div>

            {/* Heading */}
            <div style={fadeIn(140)}>
              <h1
                className={`font-heading font-black text-[2.5rem] sm:text-[3.125rem] lg:text-[3.625rem] xl:text-[4rem] tracking-tight leading-[1.0] mt-3 ${
            ...
            {/* Subtitle */}
            <p style={fadeIn(220)} className={`${isLight ? 'text-slate-800' : 'text-[#9BA8B5]'} font-medium text-[0.8125rem] sm:text-[0.875rem] max-w-sm mt-3 leading-relaxed`}>
              Building software that powers smarter, safer and more connected vehicles.
            </p>

            {/* Tech tags — shimmer hover */}
            <div style={fadeIn(300)} className={`flex items-center flex-wrap gap-x-2 gap-y-1 text-[0.6875rem] font-mono-tech tracking-wider uppercase mt-3.5 ${isLight ? 'text-slate-700 font-semibold' : 'text-[#9BA8B5] font-semibold'}`}>
            ...
            <div style={fadeIn(390)} className="flex flex-wrap sm:flex-nowrap items-center gap-3 mt-5">
              ...
              <a
                ...
                } font-medium text-[0.8125rem] tracking-wide transition-all flex items-center gap-2 cursor-pointer group hover:scale-[1.02] active:scale-[0.98]`}
              >
            ...
            <div style={fadeIn(500)} className="mt-6 flex-shrink-0">
              <img
                ...
                className="block object-contain w-full max-w-[20rem] max-h-32"
                draggable={false}
              />
            </div>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-4 mt-1">
              <div className="flex flex-col items-end text-right">
                <p className={`font-heading font-bold text-[0.625rem] xl:text-[0.6875rem] tracking-[0.2em] uppercase leading-[1.65] ${
                  isLight ? 'text-slate-900 font-black' : 'text-[#F4F7FA]'
                }`}>
                  IDEAS<br />ENGINEERED<br />FOR A BRIGHTER<br />TOMORROW
                </p>
                <div className="w-8 h-[0.125rem] bg-[#159FFF] shadow-[0_0_8px_#159FFF] rounded-full mt-1.5" />
              </div>
              ...
              >
                {/* Wireframe car */}
                <div className="relative w-[9.6875rem] xl:w-[11.5625rem] h-[4.875rem] xl:h-[5.75rem] flex items-center justify-center flex-shrink-0">
                  <div className="absolute top-0.5 left-1 font-mono-tech text-[0.4375rem] text-[#159FFF]/55 tracking-wider pointer-events-none">
                    + CAD // ISO-3/4
                  </div>
                  <img
                ...
                <div className="flex flex-col gap-1.5 pr-2">
                  {domains.map((d, i) => (
                    <span
                      key={d}
                      className={`font-heading font-bold text-[0.5625rem] xl:text-[0.59375rem] tracking-[0.14em] transition-colors duration-200 cursor-default ${
                  ...
                  <div className="w-7 h-[0.125rem] bg-[#159FFF] rounded-full mt-0.5 shadow-[0_0_6px_#159FFF]" />
                </div>
              </div>
            </div>
            ...
            >
              <p
                className={`font-heading font-black text-[1.375rem] xl:text-[1.625rem] leading-[1.1] tracking-tight ${
                  isLight ? "text-slate-900" : "text-[#F4F7FA]"
                }`}
              ...
              <div className="w-10 h-[0.125rem] bg-[#159FFF] rounded-full mt-2 ml-auto shadow-[0_0_8px_rgba(21,159,255,0.6)]" />
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <div className="grid grid-cols-2 md:flex items-center justify-between md:justify-start gap-2 sm:gap-8 lg:gap-10 w-full md:w-auto">
              {stats.map((stat, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <div className={`text-[0.9375rem] font-extrabold font-heading leading-tight transition-colors tabular-nums ${
                        isLight ? "text-slate-900 group-hover:text-[#159FFF]" : "text-[#F4F7FA] group-hover:text-[#159FFF]"
                      }`}>
                        {stat.value}
                      </div>
                      <div className={`text-[0.59375rem] font-mono-tech flex items-center gap-1 ${
            ...
            <div className="text-right flex-shrink-0">
              <p className={`text-[0.75rem] font-heading italic tracking-wide ${isLight ? "text-slate-900 font-bold" : "text-[#F4F7FA] font-bold"}`}>
                &ldquo;Code today.<br className="hidden sm:block" /> Cleaner roads tomorrow.&rdquo;
              </p>
              <div className="w-8 h-[0.125rem] bg-[#159FFF] rounded-full mt-1.5 ml-auto" />
            </div>
          </div>
        </div>
        ...
        {/* ── BOTTOM ROW ── */}
        <div
          className={`w-full flex items-center justify-between pb-2 text-[0.625rem] font-mono-tech ${isLight ? 'text-slate-600' : 'text-[#9BA8B5]'}`}
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className={`${isLight ? 'text-slate-900 font-bold' : 'text-[#F4F7FA] font-semibold'} text-[0.625rem] tracking-wider uppercase leading-tight`}>ALWAYS LEARNING</div>
              <div className={`${isLight ? 'text-slate-600 font-medium' : 'text-[#9BA8B5]'} text-[0.53125rem] tracking-wider uppercase leading-tight`}>ALWAYS BUILDING</div>
            </div>
          </div>
