  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl xl:max-w-[90rem] 2xl:max-w-[106.25rem] 3xl:max-w-[125rem] mx-auto w-full h-full flex flex-col justify-between gap-1.5 lg:gap-2">
        ...
        <div className="flex-1 min-h-0 flex flex-col justify-between gap-2 sm:gap-2.5 overflow-y-auto no-scrollbar pr-0.5">
          {experienceData.map((item, idx) => (
            ...
            >
              ...
              <div className={`flex-1 lg:flex-[1.4] rounded-2xl p-2.5 sm:px-3.5 sm:py-2.5 border transition-all flex flex-col justify-between shadow-md relative overflow-hidden min-w-0 ${
                isLight
                ...
                <div>
                  {/* Top Bar: Company Logo + Title + Current Tag (Clean, borderless transition to info bullets) */}
                  <div className="flex items-center justify-between gap-2 mb-1 sm:mb-1.5">
                    <div className="flex items-center space-x-2.5 min-w-0">
                      <div className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg p-0.5 flex items-center justify-center flex-shrink-0 shadow-sm border ${
                  ...
                  <ul className="space-y-0.5 sm:space-y-1 my-1 sm:my-1.5">
                ...
                {/* Tech Chips (Seamless, borderless transition below info) */}
                <div className="pt-1.5 sm:pt-2 mt-auto flex flex-wrap items-center gap-1">
