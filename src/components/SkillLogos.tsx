...
export const SkillLogo: React.FC<SkillLogoProps> = ({ name, className = "w-4 h-4" }) => {
  ...
  if (n === 'c' || n === 'embedded c') {
    return (
      <svg className={className} viewBox="0 0 128 128" fill="none">
        ...
        <polygon points="64,14 107,39 107,89 64,114 21,89 21,39" fill="#0A3F6E" />
  ...
  if (n.includes('c++') || n.includes('stl')) {
    return (
      <svg className={className} viewBox="0 0 128 128" fill="none">
        <polygon points="64,4 116,34 116,94 64,124 12,94 12,34" fill="#00599C" />
        <polygon points="64,14 107,39 107,89 64,114 21,89 21,39" fill="#004482" />
        ...
        {/* Plus signs */}
        <path d="M69 61 H74 V56 H77 V61 H82 V64 H77 V69 H74 V64 H69 Z" fill="#659AD2" />
        <path d="M87 61 H92 V56 H95 V61 H100 V64 H95 V69 H92 V64 H87 Z" fill="#659AD2" />
      </svg>
    );
  }
  ...
  if (n.includes('autosar')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <polygon points="64,6 118,36 118,92 64,122 10,92 10,36" fill="#1E293B" stroke="#EA580C" strokeWidth="6" />
        {/* Layered stripes representing RTE, BSW, MCAL */}
  ...
  if (n.includes('26262') || n.includes('fusa')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <path d="M64 8 L112 28 V68 C112 94 92 116 64 124 C36 116 16 94 16 68 V28 Z" fill="#1D4ED8" stroke="#60A5FA" strokeWidth="4" />
  ...
  if (n.includes('misra')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect x="22" y="16" width="84" height="96" rx="10" fill="#0F172A" stroke="#38BDF8" strokeWidth="6" />
        <rect x="42" y="8" width="44" height="16" rx="4" fill="#0284C7" />
        <path d="M40 46 H88 M40 64 H88 M40 82 H72" stroke="#94A3B8" strokeWidth="6" strokeLinecap="round" />
  ...
  if (n.includes('can') || n.includes('canoe')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="20" fill="#0F172A" stroke="#E11D48" strokeWidth="4" />
        {/* Differential CAN Bus Waveform */}
        <path d="M12 44 H36 L48 24 H76 L88 44 H116" fill="none" stroke="#38BDF8" strokeWidth="7" strokeLinecap="round" />
  ...
  if (n.includes('uds') || n.includes('diagnostic')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <circle cx="64" cy="64" r="56" fill="#0F172A" stroke="#06B6D4" strokeWidth="6" />
        {/* Diagnostic heartbeat / pulse with scanner icon */}
        <path d="M24 64 H44 L54 36 L68 92 L80 52 L90 64 H104" fill="none" stroke="#22D3EE" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  ...
  // 12. Google Test (GTest)
  if (n.includes('google') || n.includes('gtest')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        {/* Chemistry test flask with Google colors */}
        <path d="M52 14 H76 V40 L108 96 C114 106 106 118 94 118 H34 C22 118 14 106 20 96 L52 40 Z" fill="#1E293B" stroke="#4285F4" strokeWidth="6" />
  ...
  // 13. Ceedling (Unity, CMock)
  if (n.includes('ceedling') || n.includes('unity') || n.includes('cmock')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <circle cx="64" cy="64" r="56" fill="#064E3B" stroke="#10B981" strokeWidth="6" />
        {/* Sprouting seedling representing unit testing growth */}
        <path d="M64 104 V54" stroke="#A7F3D0" strokeWidth="8" strokeLinecap="round" />
  ...
  // 14. DaVinci Developer
  if (n.includes('davinci developer')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="24" fill="#1E293B" stroke="#EA580C" strokeWidth="4" />
        ...
        <polygon points="64,28 88,64 64,100 40,64" fill="#F97316" opacity="0.6" />
      </svg>
    );
  }

  // 15. DaVinci Configurator Pro
  if (n.includes('davinci configurator') || n.includes('configurator')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="24" fill="#1E293B" stroke="#10B981" strokeWidth="4" />
  ...
  // 16. Vector CANoe / Vector
  if (n.includes('vector') || n.includes('canoe')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="24" fill="#0F172A" stroke="#E11D48" strokeWidth="4" />
  ...
  // 17. Lauterbach Trace32
  if (n.includes('trace32') || n.includes('lauterbach')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="24" fill="#0F172A" stroke="#3B82F6" strokeWidth="4" />
        {/* Trace32 Blue 'A' Ladder Logo */}
        <polygon points="64,18 102,110 78,110 64,74 50,110 26,110" fill="#2563EB" />
        <polygon points="64,42 74,68 54,68" fill="#0F172A" />
  ...
  if (n.includes('creator')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="26" fill="#2C3E50" stroke="#41CD52" strokeWidth="6" />
  ...
  if (n.includes('vscode') || n.includes('vs code')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        ...
        <path d="M96 122 L38 76 L96 6 Z" fill="#1F8AD2" opacity="0.8"/>
  ...
  // 25. ClearCase / Perforce
  if (n.includes('clearcase') || n.includes('perforce')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="24" fill="#002D62" />
        {/* Intertwined helical data swirls */}
        <circle cx="46" cy="64" r="28" fill="none" stroke="#00A3E0" strokeWidth="10" />
        <circle cx="82" cy="64" r="28" fill="none" stroke="#FFFFFF" strokeWidth="10" />
      </svg>
    );
  }
  ...
  if (n.includes('linux') || n.includes('ubuntu')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        ...
        {/* Ubuntu Circle of Friends Nodes */}
  ...
  if (n.includes('qnx')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="24" fill="#001F3F" stroke="#0080FF" strokeWidth="4" />
        {/* QNX stylized Q */}
        <circle cx="60" cy="58" r="32" fill="none" stroke="#00A8FF" strokeWidth="12" />
        <path d="M72 74 L102 104" stroke="#00A8FF" strokeWidth="14" strokeLinecap="round" />
      </svg>
    );
  }
  ...
  if (n.includes('yocto')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="24" fill="#1C1D24" stroke="#FDB913" strokeWidth="4" />
        {/* Yocto gear and beaker */}
        <circle cx="64" cy="64" r="38" fill="none" stroke="#FDB913" strokeWidth="8" strokeDasharray="14 8" />
        <circle cx="64" cy="64" r="20" fill="#FDB913" />
        <circle cx="64" cy="64" r="8" fill="#1C1D24" />
      </svg>
    );
  }
  ...
  if (n.includes('rtos')) {
    return (
      <svg className={className} viewBox="0 0 128 128">
        <rect width="128" height="128" rx="24" fill="#0A192F" stroke="#00E5FF" strokeWidth="4" />
        {/* Real-time microkernel clock & scheduler */}
        <circle cx="64" cy="64" r="42" fill="none" stroke="#00E5FF" strokeWidth="6" />
        <line x1="64" y1="64" x2="64" y2="34" stroke="#00E5FF" strokeWidth="8" strokeLinecap="round" />
        <line x1="64" y1="64" x2="88" y2="64" stroke="#38BDF8" strokeWidth="6" strokeLinecap="round" />
        <circle cx="64" cy="64" r="8" fill="#00E5FF" />
      </svg>
    );
  }
